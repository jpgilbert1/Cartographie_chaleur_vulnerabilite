...
var geometry = 
    ...
    ee.Geometry.Polygon(
        [[[-71.35983146119953, 46.8707089982691],
          [-71.35983146119953, 46.785205988596914],
          [-71.13598502565266, 46.785205988596914],
          [-71.13598502565266, 46.8707089982691]]], null, false);
// MODULES DECLARATION -----------------------------------------------------------
// Total Precipitable Water 
var NCEP_TPW = require('users/jpgilbert240/test:Modules/NCEP_TPW.js')
//cloud mask
var cloudmask = require('users/jpgilbert240/test:Modules/cloudmask.js')
//Normalized Difference Vegetation Index
var NDVI = require('users/jpgilbert240/test:Modules/compute_NDVI.js')
//Fraction of Vegetation cover
var FVC = require('users/jpgilbert240/test:Modules/compute_FVC.js')
//surface emissivity
var EM = require('users/jpgilbert240/test:Modules/compute_emissivity.js')
// land surface temperature
var LST = require('users/jpgilbert240/test:Modules/SMWalgorithm.js')
// --------------------------------------------------------------------------------
