...
lit une liste de station ayant des donnees d'environnement canada de 2010 a 2020 sauvegarder localement
...
Ici, fait appel au command line pour telecharger les donnees des stations automatiquement info : https://drive.google.com/drive/folders/1WJCDEU34c60IfOnG4rv5EPZ4IhhW9vZH


```{r eval=FALSE}
for (i in 1:nrow(liste_station))
{
  debut <- 'for annee in `seq 2010 2020`;do for mois in `seq 1`;do wget --content-disposition "https://climat.meteo.gc.ca/climate_data/bulk_data_f.html?format=csv&stationID='
  ...
  {
    file.move(fichiers[j], '/Users/jean-philippegilbert/Documents/Université Laval/Cartographie vulnérabilité vagues de chaleur accamblante - General/Data/Donnees_meteo/Donnees_2010_2020')     
  }
}
```
